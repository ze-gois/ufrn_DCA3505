 ...
 */
graph_node_t* graph_find_node(graph_t* graph, void* id) {
    if (graph == NULL) {
        return NULL;
    }
 ...
 */
bool graph_edge_exists(graph_t* graph, graph_node_t* from, graph_node_t* to) {
 ...
 */
bool dfs_has_cycle(graph_t* graph, graph_node_t* node, graph_node_t* target, bool* visited) {
...
size_t graph_node_get_index(graph_node_t* node) {
    return node->index;
}
...
graph_node_t * graph_node_get_stone(graph_t* graph) {
    return graph->nodes;
}
...
graph_edge_t * graph_edge_get_stone(graph_t* graph) {
    return graph->edges;
}

graph_node_t * graph_edge_get_from(graph_edge_t* edge) {
    return edge->from;
}

graph_node_t * graph_edge_get_to(graph_edge_t* edge){
    return edge->to;
}

graph_edge_t* graph_edge_next(graph_edge_t* edge){
    return edge->next;
}
...
/**
 * Removes a directed edge between two nodes if it exists
 */
bool graph_remove_edge(graph_t* graph, graph_node_t* from, graph_node_t* to) {
    if (graph == NULL || from == NULL || to == NULL) {
        return false;
    }
