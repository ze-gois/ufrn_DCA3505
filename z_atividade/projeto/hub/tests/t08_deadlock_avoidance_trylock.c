...
/*
 * This test demonstrates how pthread_mutex_trylock can be used to avoid
 * deadlocks
 *
 ...
 *
 * When trylock fails, the thread releases any held locks and retries after a
 * delay, thus preventing the classic AB-BA deadlock pattern.
 */
