...
./build/k13_update_child:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 75 b5             	add    %dh,-0x4b(%ebp)
  10036a:	8c a1 c1 f0 43 4f    	mov    %fs,0x4f43f0c1(%ecx)
  100370:	3f                   	aas
  100371:	a7                   	cmpsl  %es:(%edi),%ds:(%esi)
  100372:	ac                   	lods   %ds:(%esi),%al
  100373:	ae                   	scas   %es:(%edi),%al
  100374:	03 b4 96 23 3b e4 06 	add    0x6e43b23(%esi,%edx,4),%esi
  10037b:	52                   	push   %edx
