...
./build/k02_test:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 f7                	add    %dh,%bh
  100369:	69 a9 ce 1e 93 64 3f 	imul   $0x3e8af93f,0x64931ece(%ecx),%ebp
  100370:	f9 8a 3e 
  100373:	af                   	scas   %es:(%edi),%eax
  100374:	86 62 eb             	xchg   %ah,-0x15(%edx)
  100377:	5c                   	pop    %esp
  100378:	ec                   	in     (%dx),%al
  100379:	db ed                	fucomi %st(5),%st
  10037b:	c8                   	.byte 0xc8
