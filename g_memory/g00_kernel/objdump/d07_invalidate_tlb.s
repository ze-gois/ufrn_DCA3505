...
./build/k07_invalidate_tlb:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 33                	add    %dh,(%ebx)
  100369:	d5 db                	aad    $0xdb
  10036b:	ec                   	in     (%dx),%al
  10036c:	2c 5e                	sub    $0x5e,%al
  10036e:	59                   	pop    %ecx
  10036f:	f1                   	int1
  100370:	3d 05 25 2b 9c       	cmp    $0x9c2b2505,%eax
  100375:	c3                   	ret
  100376:	b0 db                	mov    $0xdb,%al
  100378:	74 e1                	je     10035b <__x86.get_pc_thunk.dx+0x5b>
  10037a:	42                   	inc    %edx
  10037b:	76                   	.byte 0x76
