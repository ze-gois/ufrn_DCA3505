...
./build/k06_remove_map:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 74 fb 31          	add    %dh,0x31(%ebx,%edi,8)
  10036b:	2a f8                	sub    %al,%bh
  10036d:	77 53                	ja     1003c2 <__x86.get_pc_thunk.dx+0xc2>
  10036f:	e4 50                	in     $0x50,%al
  100371:	b2 11                	mov    $0x11,%dl
  100373:	90                   	nop
  100374:	b4 50                	mov    $0x50,%ah
  100376:	c7                   	(bad)
  100377:	cc                   	int3
  100378:	2f                   	das
  100379:	21 5f 38             	and    %ebx,0x38(%edi)
