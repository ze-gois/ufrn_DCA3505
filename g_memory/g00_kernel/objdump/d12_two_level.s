...
./build/k12_two_level:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 36                	add    %dh,(%esi)
  100369:	3c ff                	cmp    $0xff,%al
  10036b:	0b c2                	or     %edx,%eax
  10036d:	c4 82 1a 6d 4e 5f    	les    0x5f4e6d1a(%edx),%eax
  100373:	12 34 04             	adc    (%esp,%eax,1),%dh
  100376:	9b                   	fwait
  100377:	ad                   	lods   %ds:(%esi),%eax
  100378:	1a d4                	sbb    %ah,%dl
  10037a:	cc                   	int3
  10037b:	ce                   	into
