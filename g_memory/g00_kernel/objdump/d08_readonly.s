...
./build/k08_readonly:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 56 8a             	add    %dl,-0x76(%esi)
  10036a:	a1 51 ab 29 a8       	mov    0xa829ab51,%eax
  10036f:	ce                   	into
  100370:	5b                   	pop    %ebx
  100371:	d8 8c 3c d3 28 8f f6 	fmuls  -0x970d72d(%esp,%edi,1)
  100378:	43                   	inc    %ebx
  100379:	ee                   	out    %al,(%dx)
  10037a:	df 2b                	fildll (%ebx)
