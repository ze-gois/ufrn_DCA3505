...
./build/k04_read_effect:     file format elf32-i386
...
00100358 <.note.gnu.build-id>:
  ...
  100365:	4e                   	dec    %esi
  100366:	55                   	push   %ebp
  100367:	00 20                	add    %ah,(%eax)
  100369:	de 0c 82             	fimuls (%edx,%eax,4)
  10036c:	c8 4e e6 03          	enter  $0xe64e,$0x3
  100370:	7e 39                	jle    1003ab <__x86.get_pc_thunk.dx+0xab>
  100372:	50                   	push   %eax
  100373:	d9 4d 47             	(bad) 0x47(%ebp)
  100376:	f0 8c 1c 3b          	lock mov %ds,(%ebx,%edi,1)
  10037a:	55                   	push   %ebp
  10037b:	a7                   	cmpsl  %es:(%edi),%ds:(%esi)
